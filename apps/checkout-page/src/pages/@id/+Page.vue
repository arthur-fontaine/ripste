      ...
      <form class="checkout__form" novalidate>
        <div class="checkout__field">
          ...
          <input id="card-name" type="text" required autocomplete="cc-name" class="checkout__input"
            placeholder="John Doe" v-model="cardInfos.holderName" />
        </div>
        ...
        <div class="checkout__grid">
          <div class="checkout__field">
            ...
            <div class="checkout__exp-group">
              ...
              <input id="exp-year" type="text" required placeholder="YYYY" inputmode="numeric" maxlength="4"
                minlength="2" autocomplete="cc-exp-year" v-model="cardInfos.year"
                class="checkout__input checkout__input--right" />
            </div>
          </div>
