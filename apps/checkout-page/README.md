Generated with [vike.dev/new](https://vike.dev/new) ([version 458](https://www.npmjs.com/package/create-vike/v/0.0.458)) using this command:

```sh
pnpm create vike@latest --vue --tailwindcss
```
