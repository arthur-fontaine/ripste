...
export class ProductService {
  static async getAllProducts() {
    try {
      ...
      return data.map(product => ({
        ...
        sizes: product.product_sizes?.map(ps => parseInt(ps.sizes.value)) || [],
        materials: product.product_materials?.map(pm => pm.materials.name) || [],
  ...
  static async getProductById(id) {
    try {
      ...
      return {
        ...
        sizes: data.product_sizes?.map(ps => parseInt(ps.sizes.value)) || [],
  ...
  static async getFeaturedProducts(type = 'featured') {
    try {
      const { data, error } = await supabase
