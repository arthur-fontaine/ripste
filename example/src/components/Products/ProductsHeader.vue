...
const description = computed(() => {
	...
	const descriptions = {
		Sport:
			"Découvrez notre collection de chaussures de sport pour améliorer vos performances.",
		Ville:
			"Nos chaussures de ville allient élégance et confort pour votre quotidien urbain.",
		Outdoor:
			"Explorez la nature avec nos chaussures conçues pour les aventures en plein air.",
		Professionnel:
			"Sécurité et confort pour vos journées de travail avec notre gamme professionnelle.",
		...
		Saison:
			"Des modèles adaptés à chaque saison pour vous accompagner toute l'année.",
		Maison: "Confort ultime pour vos moments de détente à la maison.",
		Danse: "Performance et élégance pour tous les styles de danse.",
	};

	return (
		descriptions[props.category] ||
		`Découvrez notre sélection de produits ${props.category.toLowerCase()}.`
	);
});
</script>
