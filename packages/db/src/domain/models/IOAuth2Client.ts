...
export interface IInsertOAuth2Client extends ISU.Insertable<IOAuth2ClientTable> {}
export interface IUpdateOAuth2Client extends ISU.Updateable<IOAuth2ClientTable> {}

export const generateFakeOAuth2Client = createFakeGenerator<IOAuth2Client>('IOAuth2Client', __filename);

export const generateFakeInsertOAuth2Client = createFakeGenerator<IInsertOAuth2Client>(
	"IInsertOAuth2Client",
	__filename
);
